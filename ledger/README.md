...
18 baseball game predictions, each one committed to a public git repository
...
**9-7** on 16 graded predictions. 18 committed in total.

That is a small sample and it is not the point of this repository. A coin lands
9-7 often enough that no honest reading of it says anything yet. The
...
- Predictions with **no** GitHub push record found: **1**
- Tightest margin: **509 minutes** (8.5 hours) before first pitch
- Median margin: **1076 minutes** (17.9 hours)
- Widest margin: **2428 minutes**
...
| 17 | Dodgers at Tigers, Snell vs Montero | Dodgers win | Low | not played yet | pending | 1623 |
| 18 | Dodgers at Tigers, TBD vs Valdez | Dodgers win | High | not played yet | pending | - |
...
- **Small sample.** 16 graded games. Treat the win-loss line as a record
...
beside it. Generated 2026-08-29T14:18:19Z.
